from .views import RegistrationView,UsernameValidation,EmailValidation,LoginView,LogoutView,RequestPasswordRESEmail
...
urlpatterns = [
    ...
    path('request-reset-link',RequestPasswordRESEmail.as_view(),name='request-password')
]
